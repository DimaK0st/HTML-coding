...
class ProductImageController extends AbstractController
{
     ...
     */
    public function delete(ProductImage $productImage, ProductManager $productManager, ProductImageManager $imageManager): Response
    {
        if (!$productImage) {
            $this->addFlash('error', 'Product image not found');
        ...
        $imageManager->removeImageFromProduct($productImage, $productImageDir);
