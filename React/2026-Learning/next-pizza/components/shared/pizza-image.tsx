    ...
    return (
        <div className={cn('flex items-center justify-center flex-1 relative w-full', className)}>
            <img
                ...
                alt="Logo"
                className={
                    cn('relative left-2 transition-all z-10 duration-300', {
            ...
            <div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed border-2 rounded-full border-gray-100 w-[370px] h-[370px]"/>
        </div>
    );
};
